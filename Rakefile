...
desc 'Generate documentation for the yandex_market extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'YandexMarketExtension'
...
desc 'Test the yandex_market extension.'
...
namespace :test do
  desc 'Functional test the yandex_market extension.'
  ...
  desc 'Unit test the yandex_market extension.'
